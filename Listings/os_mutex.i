...
#line 26 "UCOSII\\CORE\\os_mutex.c"
...
#line 106 "UCOSII\\CORE\\os_mutex.c"
...
#line 198 "UCOSII\\CORE\\os_mutex.c"
    if (OSIntNesting > 0u) {                                
        *perr = 16u;                          
        return ((OS_EVENT *)0);
    }
...
#line 298 "UCOSII\\CORE\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        *perr = 1u;
        return (pevent);
    }
...
#line 442 "UCOSII\\CORE\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        *perr = 1u;
        return;
    }
...
#line 668 "UCOSII\\CORE\\os_mutex.c"
    if (pevent->OSEventType != 4u) {       
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
