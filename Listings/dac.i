...
void dac_init (void)
{
	...
	DAC_InitType.DAC_Trigger=((uint32_t)0x00000004);	
	DAC_InitType.DAC_WaveGeneration=((uint32_t)0x00000000);
	DAC_InitType.DAC_LFSRUnmask_TriangleAmplitude=((uint32_t)0x00000000);
	DAC_InitType.DAC_OutputBuffer=((uint32_t)0x00000002) ;	
    DAC_Init(((uint32_t)0x00000000),&DAC_InitType);	 
    DAC_SetChannel1Data(((uint32_t)0x00000000), 0);  

	DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0430)));

	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&((DAC_TypeDef *) (((uint32_t)0x40000000) + 0x7400))->DHR12R1;
	...
	DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0430)), &DMA_InitStructure);
	 
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0430)), ENABLE);
...
void dac1_set_vol(u16 vol)
{
	...
	DAC_SetChannel1Data(((uint32_t)0x00000000), vol);
}
