...
void uart1_dma_config (void)
{
	...
	DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)(&Detect_Buf[0][0]);  
	
	DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000010);  
	
	DMA_InitStructure.DMA_BufferSize = 1024 * 4 * 2;  
	...
	DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), ((uint32_t)0x00000002), ENABLE);  
...
{  
	if(DMA_GetITStatus(((uint32_t)0x00002000))){
		
		DMA_ClearFlag(((uint32_t)0x00002000));
		DMA_ClearITPendingBit(((uint32_t)0x00001000)); 
		USART_DMACmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0080), DISABLE); 
		DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), DISABLE);  
		
		OSQPost(debug_msg, (void *) 0xaa);
	}
} 
...
void start_uart1_dma (u32 _memBaseAddr, unsigned short _size)
{
	...
	((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044))->CMAR = _memBaseAddr;
	DMA_SetCurrDataCounter (((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), _size);
	USART_DMACmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0080),ENABLE); 
