...
#line 133 "UCOSII\\CORE\\os_time.c"
                                                  
                                                  
    ticks = ((INT32U)hours * 3600uL + (INT32U)minutes * 60uL + (INT32U)seconds) * 200u
          + 200u * ((INT32U)ms + 500uL / 200u) / 1000uL;
    OSTimeDly(ticks);
    return (0u);
}
