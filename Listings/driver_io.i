...
void drive_io_init (void)
{
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010) | ((uint16_t)0x0020) | ((uint16_t)0x0040) | ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800) | ((uint16_t)0x1000) | ((uint16_t)0x2000) | ((uint16_t)0x4000) | ((uint16_t)0x8000);
	
	 
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), &GPIO_InitStructure);	
	
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010) | ((uint16_t)0x0020) | ((uint16_t)0x0040) | ((uint16_t)0x0080) | ((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800) | ((uint16_t)0x1000) | ((uint16_t)0x2000) | ((uint16_t)0x4000) | ((uint16_t)0x8000));	
	
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(0<<2)))) = 0;
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(0<<2)))) = 1;
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(1<<2)))) = 0;
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(1<<2)))) = 1;
