...
#line 185 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (pevent);
    }
...
#line 305 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        *perr = 1u;
        return ((void *)0);
    }
...
#line 417 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (0u);
    }
...
#line 490 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 563 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 631 "UCOSII\\CORE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
