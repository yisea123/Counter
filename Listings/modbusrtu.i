...
u8 RS485_TX_BUFF[128];
u16 RS485_TX_CNT=0;



vu32 *Modbus_InputIO[100];
vu32 *Modbus_OutputIO[100];
u16 Modbus_HoldReg[1000];
...
void Modbus_RegMap(void) 
{
	...
	Modbus_InputIO[0]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) &0xFFFFF)<<5)+(6<<2))));
	Modbus_InputIO[1]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) &0xFFFFF)<<5)+(7<<2))));
	Modbus_InputIO[2]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(8<<2))));
	Modbus_InputIO[3]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(11<<2))));
	Modbus_InputIO[4]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+8) &0xFFFFF)<<5)+(0<<2))));
	Modbus_InputIO[5]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(1<<2))));
	Modbus_InputIO[6]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(2<<2))));
	Modbus_InputIO[7]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(3<<2))));
      
	
	Modbus_OutputIO[0]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(0<<2))));
	Modbus_OutputIO[1]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(1<<2))));
	Modbus_OutputIO[0]=(vu32*)& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1C00)+12) &0xFFFFF)<<5)+(0<<2))));
...
void RS485_SendData(u8 *buff, u8 len)
{
	...
	while(len--){
		...
		USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),*(buff++));
...
void modbus_analyze(u8 * _data_buf)
{
	u16 crc;
	u16 startRegAddr;
	if((_data_buf[1]==01)||(_data_buf[1]==02)||(_data_buf[1]==03)||(_data_buf[1]==05)||(_data_buf[1]==06)||(_data_buf[1]==15)||(_data_buf[1]==16))
	{
		startRegAddr=(((u16)_data_buf[2])<<8)|_data_buf[3];
		if(startRegAddr < 1000){
			crc = cmd_analyze.rec_buf[rec_count - 2] << 8 | cmd_analyze.rec_buf[rec_count - 1];
			if (crc == CRC16 (cmd_analyze.rec_buf, rec_count - 2)){
...
void Modbus_01_Solve(u8 * _data_buf)
{
	...
	startRegAddr=(((u16)_data_buf[2])<<8)|_data_buf[3];
	RegNum= (((u16)_data_buf[4])<<8)|_data_buf[5];
	if((startRegAddr+RegNum)<100)
	{
		...
		for(i=0;i<RegNum;i++)
		{
			...
			if(i==RegNum-1)
			{
				if(RegNum%8) RS485_TX_BUFF[3+i/8] >>= 8-(RegNum%8);
			}
		}
...
void Modbus_06_Solve(u8 * _data_buf)
{
	...
	startRegAddr=(((u16)_data_buf[2])<<8)|_data_buf[3];
	Modbus_HoldReg[startRegAddr]=((u16)_data_buf[4])<<8;
	Modbus_HoldReg[startRegAddr]|=_data_buf[5];
...
void Modbus_16_Solve(u8 * _data_buf)
{
	...
	if((startRegAddr+RegNum)<1000)
	{
		for(i=0;i<RegNum;i++)
		{
			Modbus_HoldReg[startRegAddr+i]=((u16)_data_buf[7+i*2])<<8; 
			Modbus_HoldReg[startRegAddr+i]|=_data_buf[8+i*2]; 
		}
