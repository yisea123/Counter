...
#line 2 "AD_Sample\\AD_Sample.c"


s_counter_info g_counter;

static int process_rdy = 0;
vu16 AD_Value_0[8][12]; 
vu16 AD_Value_1[8][12]; 
vu16 After_filter[12]; 


vu16 Detect_Buf[2][1024 * 4];
...
void AD_GPIO_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0004)|((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020);
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN; 
...
void ADC1_Configuration(void)
{
	...
	ADC_DeInit(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))); 
	...
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x01), 2, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x02), 3, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x03), 4, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0E), 5, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0F), 6, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x06), 7, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x07), 8, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x08), 9, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x09), 10, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0A), 11, ((uint8_t)0x03) );
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0B), 12, ((uint8_t)0x03) );

	
	ADC_DMACmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ENABLE);
	
	
	ADC_AnalogWatchdogThresholdsConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),0xfff,0);
	ADC_AnalogWatchdogCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),((uint32_t)0x00800000));
	ADC_ITConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint16_t)0x0140), ENABLE);

	
	ADC_ITConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint16_t)0x0220), ENABLE);
...
unsigned short detect_chanel_index = 0;
unsigned short chanel_pos_index = 0;	
unsigned short ADC_sync_signal = 0; 

void ADC1_2_IRQHandler(void)
{              
	if (ADC_GetITStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint16_t)0x0140)) != RESET) 
	{
		
		detect_chanel_index = 12 - (DMA_GetCurrDataCounter (((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008))) % 12);
		ADC_ClearFlag(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x01));
		ADC_ClearITPendingBit(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint16_t)0x0140)); 
	}
	else
	{
		chanel_pos_index++; 
		if (chanel_pos_index < 8){
		}
		else{
			chanel_pos_index = 0;
		}
		ADC_sync_signal++;
		if ( ADC_sync_signal < 8){
			ADC_SoftwareStartConvCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ENABLE);
		}else{
			chanel_pos_index = 0;
		}
		ADC_ClearITPendingBit(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint16_t)0x0220));      
	}
}
...
void AD1_DMA_Configuration(void)
{
	...
	DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->DR; 
	DMA_InitStructure.DMA_MemoryBaseAddr = (u32)&AD_Value_0; 
	DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000000); 
	DMA_InitStructure.DMA_BufferSize = 8 * 12; 
	...
	DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008)), ((uint32_t)0x00000002),ENABLE); 
...
vu16 dma_irq_cycle = 0;

void DMA1_Channel1_IRQHandler(void)
{     


	if(DMA_GetITStatus(((uint32_t)0x00000002))){
		DMA_ClearITPendingBit(((uint32_t)0x00000001)); 
		if (process_rdy < 1000){
			refresh_dma1_cycle (); 
			process_rdy++;
			ADC_sync_signal = 0;
...
#line 241 "AD_Sample\\AD_Sample.c"
...
void AD_filter(unsigned short _detect_chanel_index, unsigned short _chanel_pos_index)
{
	...
	for(i=0;i<12;i++)
	{
		...
		{
			sum += AD_Value_0[count][i];
		}
		After_filter[i]=sum/8;
		sum=0;
	}
...
void AD_Start_Sample (u32 _memBaseAddr)
{
	...
	((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008))->CMAR = _memBaseAddr;
	ADC_SoftwareStartConvCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ENABLE);
}



int save_detect_data (unsigned short _ch, unsigned short * _index, unsigned short _ad_value)
{		
...
int count_piece(s_chanel_info * _ch, unsigned short ad_value, unsigned short _ch_id)
{
	int r_code = 0;
	...
	{ 
		...
		case 0: {
			...
			_ch->wave_up_flag = 0;
			_ch->ad_value_min = 4096 * 8;
			_ch->ad_value_min_temp = 4096 * 8;
			
			_ch->std_down_v = 25000;
			_ch->std_up_v = 25000;
		...
		case 16:{	 					
			...
			if (ad_value < _ch->ad_value_min_temp){
				_ch->ad_value_min_temp = ad_value;
				_ch->wave_up_flag = 0;
			}else if (ad_value > _ch->ad_value_min_temp + 50){
				_ch->wave_up_flag++;
			}
			
			if (_ch->wave_up_flag > 8){
...
void counter_process (void)
{
	...
	if (g_counter.buf_index == 0){
		...
		AD_Start_Sample ((u32) AD_Value_1);
		g_counter.buf_index++;
	}else {
		g_counter.AD_Value_p = AD_Value_1;
		AD_Start_Sample ((u32) AD_Value_0);
		g_counter.buf_index = 0;
	}

	{ After_filter[0] = g_counter . AD_Value_p[0][0] + g_counter . AD_Value_p[1][0] + g_counter . AD_Value_p[2][0] + g_counter . AD_Value_p[3][0] + g_counter . AD_Value_p[4][0] + g_counter . AD_Value_p[5][0] + g_counter . AD_Value_p[6][0] + g_counter . AD_Value_p[7][0]; };
	{ After_filter[1] = g_counter . AD_Value_p[0][1] + g_counter . AD_Value_p[1][1] + g_counter . AD_Value_p[2][1] + g_counter . AD_Value_p[3][1] + g_counter . AD_Value_p[4][1] + g_counter . AD_Value_p[5][1] + g_counter . AD_Value_p[6][1] + g_counter . AD_Value_p[7][1]; };
	{ After_filter[2] = g_counter . AD_Value_p[0][2] + g_counter . AD_Value_p[1][2] + g_counter . AD_Value_p[2][2] + g_counter . AD_Value_p[3][2] + g_counter . AD_Value_p[4][2] + g_counter . AD_Value_p[5][2] + g_counter . AD_Value_p[6][2] + g_counter . AD_Value_p[7][2]; };
	{ After_filter[3] = g_counter . AD_Value_p[0][3] + g_counter . AD_Value_p[1][3] + g_counter . AD_Value_p[2][3] + g_counter . AD_Value_p[3][3] + g_counter . AD_Value_p[4][3] + g_counter . AD_Value_p[5][3] + g_counter . AD_Value_p[6][3] + g_counter . AD_Value_p[7][3]; };
	{ After_filter[4] = g_counter . AD_Value_p[0][4] + g_counter . AD_Value_p[1][4] + g_counter . AD_Value_p[2][4] + g_counter . AD_Value_p[3][4] + g_counter . AD_Value_p[4][4] + g_counter . AD_Value_p[5][4] + g_counter . AD_Value_p[6][4] + g_counter . AD_Value_p[7][4]; };
	{ After_filter[5] = g_counter . AD_Value_p[0][5] + g_counter . AD_Value_p[1][5] + g_counter . AD_Value_p[2][5] + g_counter . AD_Value_p[3][5] + g_counter . AD_Value_p[4][5] + g_counter . AD_Value_p[5][5] + g_counter . AD_Value_p[6][5] + g_counter . AD_Value_p[7][5]; };
	{ After_filter[6] = g_counter . AD_Value_p[0][6] + g_counter . AD_Value_p[1][6] + g_counter . AD_Value_p[2][6] + g_counter . AD_Value_p[3][6] + g_counter . AD_Value_p[4][6] + g_counter . AD_Value_p[5][6] + g_counter . AD_Value_p[6][6] + g_counter . AD_Value_p[7][6]; };
	{ After_filter[7] = g_counter . AD_Value_p[0][7] + g_counter . AD_Value_p[1][7] + g_counter . AD_Value_p[2][7] + g_counter . AD_Value_p[3][7] + g_counter . AD_Value_p[4][7] + g_counter . AD_Value_p[5][7] + g_counter . AD_Value_p[6][7] + g_counter . AD_Value_p[7][7]; };
	{ After_filter[8] = g_counter . AD_Value_p[0][8] + g_counter . AD_Value_p[1][8] + g_counter . AD_Value_p[2][8] + g_counter . AD_Value_p[3][8] + g_counter . AD_Value_p[4][8] + g_counter . AD_Value_p[5][8] + g_counter . AD_Value_p[6][8] + g_counter . AD_Value_p[7][8]; };
	{ After_filter[9] = g_counter . AD_Value_p[0][9] + g_counter . AD_Value_p[1][9] + g_counter . AD_Value_p[2][9] + g_counter . AD_Value_p[3][9] + g_counter . AD_Value_p[4][9] + g_counter . AD_Value_p[5][9] + g_counter . AD_Value_p[6][9] + g_counter . AD_Value_p[7][9]; };
	{ After_filter[10] = g_counter . AD_Value_p[0][10] + g_counter . AD_Value_p[1][10] + g_counter . AD_Value_p[2][10] + g_counter . AD_Value_p[3][10] + g_counter . AD_Value_p[4][10] + g_counter . AD_Value_p[5][10] + g_counter . AD_Value_p[6][10] + g_counter . AD_Value_p[7][10]; };
	{ After_filter[11] = g_counter . AD_Value_p[0][11] + g_counter . AD_Value_p[1][11] + g_counter . AD_Value_p[2][11] + g_counter . AD_Value_p[3][11] + g_counter . AD_Value_p[4][11] + g_counter . AD_Value_p[5][11] + g_counter . AD_Value_p[6][11] + g_counter . AD_Value_p[7][11]; };

#line 445 "AD_Sample\\AD_Sample.c"
	...
	if (my_env.print == 1){
		if (r_code != 0){
			...
			if (my_env.dma_state == 0){
				...
				g_counter.buf_index++;
				g_counter.buf_index %= 2;
				OSQPost(debug_msg, (void *) 0x55);
			}
		}
	}
	...
	counter_process_cycle = get_tim5_ticks () - tick_old + 2;
}
