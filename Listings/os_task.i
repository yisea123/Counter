...
#line 152 "UCOSII\\CORE\\os_task.c"
...
#line 452 "UCOSII\\CORE\\os_task.c"
...
#line 483 "UCOSII\\CORE\\os_task.c"
...
#line 593 "UCOSII\\CORE\\os_task.c"
    if (prio == 0xFFu) {                                  
        {cpu_sr = OS_CPU_SR_Save();};                                     
...
#line 670 "UCOSII\\CORE\\os_task.c"
    if (OSIntNesting > 0u) {                               
        *perr = 17u;
        return (0u);
    }
...
#line 750 "UCOSII\\CORE\\os_task.c"
    if (OSIntNesting > 0u) {                          
        *perr = 18u;
        return;
    }
...
#line 885 "UCOSII\\CORE\\os_task.c"
...
#line 968 "UCOSII\\CORE\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                                  
        prio = OSTCBCur->OSTCBPrio;
        self = 1u;
...
#line 1040 "UCOSII\\CORE\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        prio = OSTCBCur->OSTCBPrio;
    }
...
#line 1110 "UCOSII\\CORE\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        ptcb = OSTCBCur;
    } else {
...
#line 1176 "UCOSII\\CORE\\os_task.c"
    {cpu_sr = OS_CPU_SR_Save();};
    if (prio == 0xFFu) {                   
        ptcb = OSTCBCur;
    } else {
...
#line 1258 "UCOSII\\CORE\\os_task.c"
        }
    }
}
